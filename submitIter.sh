...
#python $HOME/code/preproc.py $1 $2 $3 $4
#python $HOME/code/microstructure.py $1 $2 $3 $4
#python $HOME/code/ODF.py $1 $2 $3 $4
#python $HOME/code/MF.py $1 $2 $3 $4
...
python $HOME/code/merge_dic_dev.py $1 $2 $3 $4
